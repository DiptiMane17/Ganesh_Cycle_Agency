...
{
    public partial class frm_View_All_Distributor : Form
    {
        public frm_View_All_Distributor()
        {
            InitializeComponent();
        }
        ...
        void Bind_Grid(string Query)
        {
            ...
            sda.Fill(dt);
            dgv_View_All_Distributors.DataSource = dt;
            Con_Close();
        }
        void Clear_Control()
        {
        ...
        Boolean Flag;
        private void frm_View_All_Distributor_Load(object sender, EventArgs e)
        {
        ...
        private void tb_Search_TextChanged(object sender, EventArgs e)
        {
            if (Flag == false)
            {
                Bind_Grid("Select * From Distributor_Details where Distributor_ID like '" + tb_Search.Text + "%'");

            }
            else if (Flag == true)
            {
                Bind_Grid("Select * From Distributor_Details where Distributor_Name like '" + tb_Search.Text + "%'");
            }
        }
